-- ============================================================
-- SCHEMA 04: RESERVAS Y CONFIGURACIÓN DEL NEGOCIO
-- Descripción: Sistema de reservas de mesas y configuración
--              general por tenant (geofencing, horarios, etc.)
-- Autor: SaasSystemGuri
-- ============================================================

-- ============================================================
-- TABLA: reservas_config
-- Propósito: Configuración general del sistema de reservas
--            del tenant. Relación 1:1 con el tenant.
-- ============================================================
CREATE TABLE reservas_config (
    ...
    -- Mínimo de horas de anticipación para hacer una reserva.
    cancelacion_limite_hs    INTEGER NOT NULL DEFAULT 24 CHECK (cancelacion_limite_hs >= 0)
    -- Horas límite antes de la reserva para poder cancelar sin penalidad.
);
...
-- ============================================================
-- TABLA: reserva_horarios_disponibles
-- Propósito: Franjas horarias configuradas por el tenant para reservas.
--            Ej: Mañana (08:00-12:00), Noche (20:00-23:00).
-- ============================================================
CREATE TABLE reserva_horarios_disponibles (
    id        UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    nombre    VARCHAR(100) NOT NULL,    -- Ej: "Almuerzo", "Cena"
...
-- Propósito: Control diario del calendario de reservas.
--            Una fila por fecha, para deshabilitar días completos.
-- ============================================================
...
-- ============================================================
-- TABLA: reservas_calendario_horarios
-- Propósito: Disponibilidad por franja horaria para cada fecha.
--            Tabla de intersección entre calendario y horarios.
-- ============================================================
...
-- ============================================================
-- TABLA: reservas
-- Propósito: Registro de cada reserva realizada por un cliente.
-- ============================================================
...
-- Propósito: Parámetros generales del negocio por tenant.
--            Incluye geofencing y configuraciones del sistema.
--            Relación 1:1 con el tenant.
-- ============================================================
CREATE TABLE configuracion_negocio (
    ...
    logo_menu_url           VARCHAR(500)  -- Logo que ve el cliente en el menú QR
);
